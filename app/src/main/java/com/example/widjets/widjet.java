...
public class widjet extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        views = new RemoteViews(context.getPackageName(), R.layout.widjetsfile);
        componentName = new ComponentName(context, widjet.class);
    ...
    private class JokeLoader extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids){
            ...
            try{
                ...
                widjet.futureJokeString = jsonObject.getString("value");
            }
